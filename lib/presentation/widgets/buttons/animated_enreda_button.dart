...
class AnimatedEnredaButton extends StatefulWidget {
  final String title;
  ...
  AnimatedEnredaButton({
    ...
    this.leadingButtonColor = AppColors.primary200,
    this.trailingButtonColor = AppColors.primary300,
  ...
  @override
  _AnimatedEnredaButtonState createState() => _AnimatedEnredaButtonState();
}

class _AnimatedEnredaButtonState extends State<AnimatedEnredaButton> {
