...
import 'package:enreda_app/presentation/pages/home/sections/register_new_user/mentorUser/mentor_revision_form.dart';
...
class MentorRegistering extends StatefulWidget {
  const MentorRegistering({Key? key}) : super(key: key);

  @override
  _MentorRegisteringState createState() => _MentorRegisteringState();
}

class _MentorRegisteringState extends State<MentorRegistering> {
  ...
  Future<void> _submit() async {
    if (_validateCheckField()) {
      ...
      try {
        ...
        await database.addMentorUser(mentorUser);
        showAlertDialog(
          context,
  ...
  */
  ...
  Widget _generalMentorForm(BuildContext context) {
    final database = Provider.of<Database>(context, listen: false);
    ...
    return
      Form(
        ...
        children: <Widget> [
          CustomFlexRowColumn(
            childLeft: CustomTextFormFieldName(context, _name!, StringConst.FORM_NAME, StringConst.NAME_ERROR, _name_setState),
            childRight: CustomTextFormFieldName(context, _surname!, StringConst.FORM_LASTNAME, StringConst.FORM_LASTNAME_ERROR, _surname_setState),
          ),
          Flex(
  ...
  Widget _revisionForm(BuildContext context) {
    return Column(
      children: [
        ...
        CheckboxForm(context, _checkFieldKey, _isChecked, _buildAgreeToTermsField_setState)
      ],
    );
  }
  ...
  void _buildAgreeToTermsField_setState(bool? val) {
    setState(() => this._isChecked = val!);
  }
  ...
  List<Step> getSteps() => [
      Step(
        ...
        content: _generalMentorForm(context),
      ),
      Step(
            ...
            appBar: AppBar(
              ...
              title: Row(
                ...
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.all(Borders.kDefaultPaddingDouble / 2), child: Text(StringConst.FORM_MENTOR_REGISTER.toUpperCase(),
