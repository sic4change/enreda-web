...
class ImagePath {
  ...
  static const String APP_STORE = "$imageDir/app_store_900x503.png";
  ...
  static const String FOOTER_CIRCLE = "$imageDir/footer-circulo-4px.png";
  static const String FOOTER_ASK = "$imageDir/footer-interrogante.png";
  static const String FOOTER_CONTACT = "$imageDir/footer-icono-contacto.png";
  static const String FOOTER_CALL = "$imageDir/footer-icono-llamada.png";
  static const String HOME_CIRCLE_WEB = "$imageDir/footer-circulo-4px.png";
  static const String HOME_CIRCLE_MOBILE = "$imageDir/circulo-primera-pagina-mobile.png";

  // Images
  static const String DEV_ABOUT_ME = "$imageDir/dev_aboutme.png";
  static const String DEV_HEADER = "$imageDir/carrousel-1.png";
  static const String DEV_HEADER2 = "$imageDir/carrousel-2.png";
  static const String DEV_HEADER3 = "$imageDir/carrousel-3.png";
  static const String DEV_HEADER_EMPTY = "$imageDir/dev_header_empty.png";
  ...
  static const String ICON_ROCKET_JOB = '$imageDir/icon-rocket-job.png';
  static const String ICON_ROCKET_COMPANY = '$imageDir/icon-rocket-company.png';
  static const String ICON_GEARS = '$imageDir/icon-gears.png';
  static const String ICON_BULB = '$imageDir/icon-bulb.png';
  static const String ICON_ASTRONAUT = '$imageDir/icon-astronaut.png';
  ...
  static const String REDISCOVER_TEXT_FR = '$imageDir/rediscover-text-fr.png';
  ...
  static const String REIMAGINE_TITLE_IMAGE_FR = '$imageDir/reimagine-title-image-fr.png';
  ...
  static const String REBUILD_TITLE_IMAGE_FR = '$imageDir/rebuild-title-image-fr.png';
  ...
  // Card Skills
  static const String SKILL_01 = "$imageDir/card-jovenes.png";
  static const String SKILL_02 = "$imageDir/card-instituciones.png";
  static const String SKILL_03 = "$imageDir/card-empresas.png";
  static const String SKILL_04 = "$imageDir/card-ciudadania.png";

  //Card Images
  static const String SEARCH_JOB = "$imageDir/1-busco-trabajo-ilustracion.png";
  static const String FOR_ORGANIZATION = "$imageDir/1-soy-organizacion-ilustracion.png";
  static const String FOR_COLABORATOR = "$imageDir/1-quiero-colab-ilustracion.png";
  ...
  static const String PORTFOLIO_4bn = "$imageDir/company_04bn.png";
  ...
  static const String FINANCIER_2 = "$imageDir/financier-2.png";
  static const String FINANCIER_3 = "$imageDir/financier-3.png";
  static const String FINANCIER_4 = "$imageDir/financier-4.png";
  static const String FINANCIER_5 = "$imageDir/financier-5.png";
  static const String FINANCIER_6 = "$imageDir/financier-6.png";
  static const String ENREDADA_1 = "$imageDir/enredada-1.png";
  static const String ENREDADA_2 = "$imageDir/enredada-2.png";
  static const String ENREDADA_3 = "$imageDir/enredada-3.png";
  ...
  static const String ICON_CHAT = '$imageDir/icon-chat.png';
  static const String ICON_COMPETENCIES = '$imageDir/icon-competencies.png';
  static const String ICON_GAMIFICATION = '$imageDir/icon-gamification.png';
  static const String ICON_CV_CREATION = '$imageDir/icon-cv-creation.png';
  static const String ICON_RESOURCE_ACCESS = '$imageDir/icon-resource-access.png';
  static const String ICON_ENREDA_APP = '$imageDir/icon-enreda-app.png';
  static const String ICON_DART = '$imageDir/icon-dart.png';
  static const String ICON_CANDIDATES = '$imageDir/icon-candidates.png';
  static const String ICON_METHODOLOGY = '$imageDir/icon-methodology.png';
  static const String ICON_DESIGN = '$imageDir/icon-design.png';
  static const String ICON_DIRECTORY = '$imageDir/icon-directory.png';
